...
do_generate[depends] += "sip-native5:do_populate_sysroot"
...
sip5_do_generate() {
	...
	do
		install -d ${module}/
		echo "calling 'sip5 -I sip ${SIPTAGS} ${FEATURES} -c ${S}/${module} -b ${module}/${module}.pro.in sip/${module}/${module}mod.sip'"
		sip5 -I ${STAGING_SIPDIR} -I sip ${SIPTAGS} ${FEATURES} -c ${module} -b ${module}/${module}.sbf \
